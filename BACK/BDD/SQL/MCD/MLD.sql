...
facture = (Id_facture INT, num_facture INT, fact_facture VARCHAR(50), prixht_facture DECIMAL(15,2), date_facture DATE, prixttc_facture DECIMAL(15,2), #Id_com);
...
livrer = (#ref_article, #Id_facture, adresse_livraison VARCHAR(50), adresse_facturation VARCHAR(50));
